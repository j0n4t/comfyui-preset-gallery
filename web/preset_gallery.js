...
styles.textContent = `
    .j0n4t-pg-wrap { display: flex; flex-direction: column; gap: 8px; padding: 0; border-radius: 4px; box-sizing: border-box; width: 100%; height: 100%; font-family: sans-serif; }
